...
$rootScope.App.ID = "com.appbuil.test";
$rootScope.App.Name = "Test App1";
$rootScope.App.Version = "1.0.0";
$rootScope.App.Description = "Test App1";
$rootScope.App.AuthorName = "";
$rootScope.App.AuthorEmail = "";
$rootScope.App.AuthorUrl = "";
$rootScope.App.LanguageCode = "en";
$rootScope.App.TextDirection = "rtl";
...
$rootScope.IFrame1.Url = "http://www.aria-law.com";
$rootScope.IFrame1.Class = "";
    };
...
window.App.Ctrls.controller("View1Ctrl", ["$scope", "$rootScope", "$sce", "$interval", "$http", "$uibPosition", "blockUI",
